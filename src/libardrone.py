...
class ARDrone(object):
    ...
    def move(self, lr, fb, vv, va):
        ...
        Parameters:
            ...
            b -- front-back tilt: float [-1..1] negative: forwards, positive: backwards
            vv -- vertical speed: float [-1..1] negative: go down, positive: rise
            va -- angular speed: float [-1..1] negative: spin left, positive: spin right
        """
...
def at(command, seq, params):
    ...
    sock.sendto(msg, (ARDRONE_ADDR, ARDRONE_COMMAND_PORT))
